...
- As travas automáticas (`tests/padraoAbas.test.ts`, `tests/repoHygiene.test.ts` e o checklist do PR no CI) não podem ser afrouxadas; a lista `PENDENCIAS` só diminui.
